...
print("1: Image Mode (will capture the first frame of a video, calculate the motion for the next 24 frames and them show the image")
print("2: Video Mode (will calculate the motion in real time, and show it on video to you)")
x = int(raw_input())
if x == 2:
    video_mode = True
